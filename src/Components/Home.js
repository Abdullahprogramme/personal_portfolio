            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                ...
                <div className="flex flex-row mt-4">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <motion.p className="text-white py-1 max-w-[700px]" variants={itemVariants}>
                            Welcome to my portfolio! I specialize in crafting beautiful and functional web applications.
                        </motion.p>
                        <motion.p className="text-white py-1 max-w-[700px]" variants={itemVariants}>
                            With a strong foundation in React and modern web technologies, I turn ideas into reality.
                        </motion.p>
                        <motion.p className="text-white py-1 max-w-[700px]" variants={itemVariants}>
                ...
                <div className="z-10 pt-2">
                    <div className="inline-block"><Link to="work" duration={700} smooth={true} className=" text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-500 hover:border-pink-500">View work
